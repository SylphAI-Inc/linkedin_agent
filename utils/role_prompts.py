...
class RolePromptBuilder:
    ...
    def build_enhanced_prompt(
        ...
        prompt_parts.extend([
            ...
            f"• search_results = smart_candidate_search(query='{base_query}', location='{location}', target_candidate_count={limit})",
            f"• Note: Search doesn't need strategy parameter, but evaluation will",
            ...
            f"- Step 2: smart_candidate_search() → extracted_data (no strategy needed)",
