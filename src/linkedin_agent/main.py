...
from .utils.logger import init_logging, log_info, log_error, log_debug, log_phase_start, log_phase_end
...
def main():
    ...
    if args.job_description:
        try:
            ...
            log_error("Error reading job description file", phase="initialization", exception=e)
            sys.exit(1)
    ...
    if candidates:
        ...
        log_info("📊 Final result: No candidates found - consider adjusting search parameters")
